...
/*
 *  mt6983-mt6338.c  --  mt6983 mt6338 ALSA SoC machine driver
 *
...
static const struct soc_enum mt6983_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6983_spk_type_str),
			    mt6983_spk_type_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6983_spk_i2s_type_str),
			    mt6983_spk_i2s_type_str),
};

static int mt6983_spk_type_get(struct snd_kcontrol *kcontrol,
...
static int mt6983_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6983_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6983_mt6338_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6983_mt6338_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6983_mt6338_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6983_mt6338_routes[] = {
...
static const struct snd_kcontrol_new mt6983_mt6338_controls[] = {
	...
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6983_spk_type_enum[0],
		     mt6983_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6983_spk_type_enum[1],
 ...
 * BE i2s need assign snd_soc_ops = mt6983_mt6338_i2s_ops
 */
static int mt6983_mt6338_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6983_mt6338_i2s_ops = {
	.hw_params = mt6983_mt6338_i2s_hw_params,
};

static int mt6983_mt6338_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6983_afe_gpio_is_prepared(MT6983_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6983_afe_gpio_is_prepared(MT6983_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6983_afe_gpio_is_prepared(MT6983_AFE_GPIO_DAT_MISO2_ON);

	mt6983_afe_gpio_request(afe, true, MT6983_DAI_ADDA, 1);
	mt6983_afe_gpio_request(afe, true, MT6983_DAI_ADDA, 0);
	mt6983_afe_gpio_request(afe, true, MT6983_DAI_ADDA_CH34, 1);
	mt6983_afe_gpio_request(afe, true, MT6983_DAI_ADDA_CH34, 0);
	...
	mt6983_afe_gpio_request(afe, false, MT6983_DAI_ADDA_CH34, 1);
	mt6983_afe_gpio_request(afe, false, MT6983_DAI_ADDA_CH34, 0);
...
static int mt6983_mt6338_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	ops.set_lch_dc_compensation = mt6983_set_lch_dc_compensation;
	ops.set_rch_dc_compensation = mt6983_set_rch_dc_compensation;
	ops.adda_dl_gain_control = mt6983_adda_dl_gain_control;
	...
	/* mtkaif calibration */
	mt6983_mt6338_mtkaif_calibration(rtd);
...
static int mt6983_mt6338_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6983_mt6338_vow_hardware);

	mt6983_afe_gpio_request(afe, true, MT6983_DAI_VOW, 0);
...
static void mt6983_mt6338_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	mt6983_afe_gpio_request(afe, false, MT6983_DAI_VOW, 0);
...
static const struct snd_soc_ops mt6983_mt6338_vow_ops = {
	.startup = mt6983_mt6338_vow_startup,
	.shutdown = mt6983_mt6338_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6983_mt6338_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
...
static struct snd_soc_card mt6983_mt6338_soc_card = {
	.name = "mt6983-mt6338",
	.owner = THIS_MODULE,
	.dai_link = mt6983_mt6338_dai_links,
	.num_links = ARRAY_SIZE(mt6983_mt6338_dai_links),

	.controls = mt6983_mt6338_controls,
	.num_controls = ARRAY_SIZE(mt6983_mt6338_controls),
	.dapm_widgets = mt6983_mt6338_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6983_mt6338_widgets),
	.dapm_routes = mt6983_mt6338_routes,
...
static const struct of_device_id mt6983_mt6338_dt_match[] = {
	{.compatible = "mediatek,mt6983-mt6338-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6983_mt6338_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6983_mt6338_driver = {
	.driver = {
		.name = "mt6983-mt6338",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6983_mt6338_dt_match,
#endif
		.pm = &mt6983_mt6338_pm_ops,
	},
	.probe = mt6983_mt6338_dev_probe,
};

module_platform_driver(mt6983_mt6338_driver);

/* Module information */
MODULE_DESCRIPTION("MT6983 mt6338 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6983 mt6338 soc card");
