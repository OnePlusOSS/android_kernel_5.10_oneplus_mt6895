...
#define PFX "CAM_CAL_IMX355_21143"
...
static unsigned int do_single_lsc_imx355(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_imx355(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_imx355(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x00650006, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_imx355},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_imx355},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_imx355}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT imx355_op_tri_eeprom_21143 = {
	.name = "imx355_op_tri_eeprom_21143",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	pr_debug("IMX355 block_size=%d sensor_id=%x\n", block_size, pCamCalData->sensorID);
