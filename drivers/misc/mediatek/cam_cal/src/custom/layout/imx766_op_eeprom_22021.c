...
#define PFX "CAM_CAL_IMX766_22021"
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
    0x00000006, 0x0155000E, CAM_CAL_SINGLE_EEPROM_DATA,
    {
        ...
        {0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx766}, //Start address, block size is useless
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT imx766_op_eeprom_22021 = {
    .name = "imx766_op_eeprom_22021",
