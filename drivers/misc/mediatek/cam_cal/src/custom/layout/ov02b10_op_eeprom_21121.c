...
static unsigned int do_single_lsc_ov02b10(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_ov02b10(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_ov02b10(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000005, 0x0000cb99, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000001, do_part_number},
		{0x00000001, 0x00000C00, 0x0000074C, do_single_lsc_ov02b10},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_ov02b10},  //Start address, block size is useless
		...
		{0x00000001, 0x00000006, 0x00000002, do_lens_id_ov02b10}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT ov02b10_op_eeprom_21121 = {
	.name = "ov02b10_op_eeprom_21121",
