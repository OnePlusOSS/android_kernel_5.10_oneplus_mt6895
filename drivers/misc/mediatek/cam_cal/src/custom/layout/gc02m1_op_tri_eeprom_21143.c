...
#define PFX "CAM_CAL_GC02M1_21143"
...
static unsigned int do_single_lsc_gc02m1(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_gc02m1(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_gc02m1(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x00CA007D, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000C00, 0x0000074C, do_single_lsc_gc02m1},
		{0x00000001, 0x0000000E, 0x0000000E, do_2a_gain_gc02m1},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_gc02m1}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT gc02m1_op_tri_eeprom_21143 = {
	.name = "gc02m1_op_tri_eeprom_21143",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	pr_debug("GC02M1 block_size=%d sensor_id=%x\n", block_size, pCamCalData->sensorID);
