...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0157000B, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_imx709},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx709},  //Start address, block size is useless
		{0x00000001, 0x00001300, 0x000005EE, do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT imx709_op_eeprom_21121 = {
	.name = "imx709_op_eeprom_21121",
