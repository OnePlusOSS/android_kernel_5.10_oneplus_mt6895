...
#ifndef __MODEM_DPMA_V3_H__
#define __MODEM_DPMA_V3_H__
...
struct dpmaifq_normal_pit {
	...
	unsigned int	pit_seq:8;        //old, from pit_seq:16
	unsigned int	h_bid:3;          //new, from pit_seq:16
	unsigned int	reserved2:5;      //new, from pit_seq:16
	unsigned int	ig:1;
	unsigned int	bi_f:2;           //new, from reserved2:7
	unsigned int	header_offset:5;  //new, from reserved2:7
...
struct dpmaifq_msg_pit {
	...
	unsigned int    hpc_idx:4;     //new, from reserved:8
	unsigned int    reserved:4;    //old, from reserved:8
	...
	unsigned int    pro:2;         //new, from reserved6:16
	unsigned int    reserved5:6;   //old, from reserved6:16
	unsigned int    hash:8;        //new, from reserved6:16

	unsigned int    pit_seq:8;     //old, from pit_seq:16
	unsigned int    h_bid:3;       //new, from pit_seq:16
	unsigned int    reserved6:5;   //new, from pit_seq:16
	unsigned int    ig:1;
	unsigned int    reserved7:3;   //old, from reserved7:7
	unsigned int    mr:2;          //new, from reserved7:7
	unsigned int    reserved8:1;   //new, from reserved7:7
	unsigned int    ip:1;          //new, from reserved7:7
