 ...
 *
 ****************************************************************************/
#ifndef _IMX709MIPI_SENSOR_21121_H
#define _IMX709MIPI_SENSOR_21121_H
...
struct imgsensor_info_struct {
    ...
    kal_uint8 custom6_delay_frame; /* enter custom3 delay frame num */
    kal_uint8 custom7_delay_frame; /* enter custom4 delay frame num */
    kal_uint8 custom8_delay_frame; /* enter custom4 delay frame num */
    kal_uint8 custom9_delay_frame; /* enter custom4 delay frame num */
