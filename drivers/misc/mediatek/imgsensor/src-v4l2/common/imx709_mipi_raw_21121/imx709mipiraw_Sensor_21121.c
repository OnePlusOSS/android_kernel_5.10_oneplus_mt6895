...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 3264, 2448, 0x00, 0x00, 0x00, 0x00,
	 0x00, 0x30, 1015, 1216, 0x00, 0x00, 0x0000, 0x0000},
	/* Normal_Video mode setting 4000*2256*/
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 3264, 1856, 0x00, 0x00, 0x00, 0x00,
	 0x00, 0x30, 1016, 928, 0x00, 0x00, 0x0000, 0x0000},
...
static void read_module_data(struct subdrv_ctx *ctx)
{
    ...
    qsc_is_valid = read_cmos_eeprom_8(ctx, 0x1418);
    lrc_is_valid = read_cmos_eeprom_8(ctx, 0x162e);
...
static void write_sensor_QSC(struct subdrv_ctx *ctx)
{
    ...
    if (qsc_is_valid && !qsc_flag) {
        imx709_seq_write_cmos_sensor(ctx, 0x1000, imx709_QSC_setting,
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    *feature_para_len = OPLUS_CAMERA_COMMON_DATA_LENGTH;
    ...
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
        case SENSOR_SCENARIO_ID_NORMAL_CAPTURE:
            imgsensor_pd_info.i4BlockNumX = 203;
            imgsensor_pd_info.i4BlockNumY = 152;
        ...
        case SENSOR_SCENARIO_ID_NORMAL_VIDEO:
            imgsensor_pd_info.i4BlockNumX = 203;
            imgsensor_pd_info.i4BlockNumY = 115;
            memcpy((void *)PDAFinfo,
                (void *)&imgsensor_pd_info,
                sizeof(struct SET_PD_BLOCK_INFO_T));
        break;
