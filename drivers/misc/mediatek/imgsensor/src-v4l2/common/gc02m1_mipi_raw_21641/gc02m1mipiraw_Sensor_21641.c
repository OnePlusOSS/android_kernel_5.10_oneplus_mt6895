...
#include "gc02m1mipiraw_Sensor_21641.h"
#include "gc02m1_eeprom_21641.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID_21641,
...
static BYTE gc02m1_common_data_21641[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
static void read_module_data(struct subdrv_ctx *ctx)
{
	kal_uint16 idx = 0;
	read_gc02m1_eeprom_info_21641(ctx, EEPROM_META_MODULE_ID,
				&(gc02m1_common_data_21641[0]), 2);
	imgsensor_info.module_id = (kal_uint16)(gc02m1_common_data_21641[1] << 8) |
				   gc02m1_common_data_21641[0];
	read_gc02m1_eeprom_info_21641(ctx, EEPROM_META_SENSOR_ID,
				&(gc02m1_common_data_21641[2]), 2);
	read_gc02m1_eeprom_info_21641(ctx, EEPROM_META_LENS_ID,
				&(gc02m1_common_data_21641[4]), 2);
	read_gc02m1_eeprom_info_21641(ctx, EEPROM_META_VCM_ID,
				&(gc02m1_common_data_21641[6]), 2);
	read_gc02m1_eeprom_info_21641(ctx, EEPROM_META_MODULE_SN,
				&(gc02m1_common_data_21641[8]), 17);

	for (idx = 0; idx < 30; idx = idx + 4)
		printk(KERN_ERR "cam data: %02x %02x %02x %02x\n",
		       gc02m1_common_data_21641[idx], gc02m1_common_data_21641[idx + 1],
		       gc02m1_common_data_21641[idx + 2],
		       gc02m1_common_data_21641[idx + 3]);
}
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, gc02m1_common_data_21641,
...
const struct subdrv_entry gc02m1_mipi_raw_21641_entry = {
	.name = "gc02m1_mipi_raw_21641",
	.id = GC02M1_SENSOR_ID_21641,
	.pw_seq = pw_seq,
