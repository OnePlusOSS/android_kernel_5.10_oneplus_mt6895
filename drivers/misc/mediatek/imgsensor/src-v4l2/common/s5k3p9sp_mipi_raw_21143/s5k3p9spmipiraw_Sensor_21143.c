...
#include "s5k3p9spmipiraw_Sensor_21143.h"
#include "s5k3p9sp_ana_gain_table_21143.h"
#include "s5k3p9sp_Sensor_setting_21143.h"
...
#define s5k3p9sp_table_write_cmos_sensor_8_21143(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define s5k3p9sp_table_write_cmos_sensor_16_21143(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define s5k3p9sp_burst_write_cmos_sensor_8_21143(...) subdrv_i2c_wr_p8(__VA_ARGS__)
#define s5k3p9sp_burst_write_cmos_sensor_16_21143(...) subdrv_i2c_wr_p16(__VA_ARGS__)

#define S5K3P9SP_EEPROM_READ_ID_21143  0xA9
#define S5K3P9SP_EEPROM_WRITE_ID_21143 0xA8

#define PFX "S5K3P9SP_camera_sensor_21143"
...
{
	if (_size_to_write) {
		s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, _i2c_data, _size_to_write);
...
static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SP_SENSOR_ID_21143,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	s5k3p9sp_burst_write_cmos_sensor_8_21143(ctx, 0x6F12,
...
#else
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_init,
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_preview_21143,
		   sizeof(addr_data_pair_preview_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	preview_setting  */

static void capture_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_capture_21143,
		   sizeof(addr_data_pair_capture_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	capture_setting  */

static void normal_video_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_normal_video_21143,
		sizeof(addr_data_pair_normal_video_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	normal_video_setting  */

static void hs_video_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_hs_video_21143,
		sizeof(addr_data_pair_hs_video_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	hs_video_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_slim_video_21143,
		   sizeof(addr_data_pair_slim_video_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	slim_video_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_custom1_21143,
		   sizeof(addr_data_pair_custom1_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom1_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_custom2_21143,
		   sizeof(addr_data_pair_custom2_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom2_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21143(ctx, addr_data_pair_custom3_21143,
		   sizeof(addr_data_pair_custom3_21143) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom3_setting  */
...
{
    kal_uint16 idx = 0;
    read_s5k3p9sp_eeprom_info_21143(ctx, EEPROM_META_MODULE_ID,
                &(s5k3p9sp_common_data[0]), 2);
    read_s5k3p9sp_eeprom_info_21143(ctx, EEPROM_META_SENSOR_ID,
                &(s5k3p9sp_common_data[2]), 2);
    read_s5k3p9sp_eeprom_info_21143(ctx, EEPROM_META_LENS_ID,
                &(s5k3p9sp_common_data[4]), 2);
    read_s5k3p9sp_eeprom_info_21143(ctx, EEPROM_META_VCM_ID,
                &(s5k3p9sp_common_data[6]), 2);
    read_s5k3p9sp_eeprom_info_21143(ctx, EEPROM_META_MODULE_SN,
...
static void read_four_cell_from_eeprom(struct subdrv_ctx *ctx, char *data)
{
	...
	if (data != NULL) {
		...
		ret = adaptor_i2c_rd_u8(ctx->i2c_client,
			S5K3P9SP_EEPROM_READ_ID_21143 >> 1, FOUR_CELL_ADDR, &temp);
		if (ret < 0) {
		...
		for (i = 2; i < (FOUR_CELL_SIZE + 2); i++)
			adaptor_i2c_rd_u8(ctx->i2c_client,
				S5K3P9SP_EEPROM_READ_ID_21143 >> 1, FOUR_CELL_ADDR, &four_cell_data[i]);
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(s5k3p9sp_ana_gain_table_21143);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)s5k3p9sp_ana_gain_table_21143,
			sizeof(s5k3p9sp_ana_gain_table_21143));
		}
		break;
...
const struct subdrv_entry s5k3p9sp_mipi_raw_21143_entry = {
	.name = "s5k3p9sp_mipi_raw_21143",
	.id = S5K3P9SP_SENSOR_ID_21143,
	.pw_seq = pw_seq,
