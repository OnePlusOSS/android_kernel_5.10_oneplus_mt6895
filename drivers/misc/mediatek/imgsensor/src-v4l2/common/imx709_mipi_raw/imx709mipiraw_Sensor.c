...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .normal_video = { /* reg_C3 3264*1856@30fps*/
        .pclk = 859200000,
        .linelength = 7400,
        .framelength = 3864,
        .startx = 0,
    ...
    .custom1 = { /*reg I3 3264*1856@30FPS */
        .pclk = 859200000,
        .linelength = 7456,
        .framelength = 1920,
        .startx = 0,
    ...
    .custom4 = {  /* custom4 reg_H 1632x1224@15FPS */
        .pclk = 374400000,
        .linelength = 5880,
        .framelength = 2120,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    {6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* Preview  reg_B2*/
    {6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* capture  reg_B2*/
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* normal video reg_I2*/
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* hs_video  reg_C1-2*/
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* slim video reg_C1-2*/
    {6560, 4928, 0, 608, 6560, 3712, 3280, 1856,  8,   0, 3264, 1856,  0,  0, 3264, 1856}, /* custom1  reg_C2*/
    {6560, 4928, 0,  16, 6560, 4896, 6560, 4896, 16,   0, 6528, 4896,  0,  0, 6528, 4896}, /* custom2  reg_B2*/
    {6560, 4928, 0,  16, 6560, 4896, 6560, 4896, 16,   0, 6528, 4896,  0,  0, 6528, 4896}, /* custom3  reg_A3*/
    {6560, 4928, 0,   0, 6560, 4928, 1640, 1232,  4,   4, 1632, 1224,  0,  0, 1632, 1224}, /* custom4  reg_I3*/
#if 0
...
static void write_frame_len(struct subdrv_ctx *ctx, kal_uint32 fll, kal_uint32 exp_cnt)
{
...
/*
    ctx->frame_length = round_up(fll , 8);
...
static void write_shutter(struct subdrv_ctx *ctx, kal_uint32 shutter)
{
    ...
    if (longexposure_times > 0) {
        ...
        write_cmos_sensor_8(ctx, 0x0104, 0x01);
        write_cmos_sensor_8(ctx, 0x3100, 0x00);
        write_cmos_sensor_8(ctx, 0x0340, ctx->frame_length >> 8);
        write_cmos_sensor_8(ctx, 0x0341, ctx->frame_length & 0xFF);
        write_cmos_sensor_8(ctx, 0x0104, 0x00);
...
static kal_uint16 imx709_normal_video_setting[] = {
    //3264x1856 @30FPS ( Seamless switch with reg_I3 )
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void hdr_write_double_shutter(struct subdrv_ctx *ctx, kal_uint16 le, kal_uint16 se)
{
    kal_uint16 realtime_fps = 0;
    ...
    ctx->frame_length = max((kal_uint32)(le + se + (2 * imgsensor_info.margin)),
    ...
    LOG_INF("E! le:0x%x, se:0x%x autoflicker_en %d frame_length %d\n",
        le, se, ctx->autoflicker_en, ctx->frame_length);
...
#if 0
    //read back
    le_b = ((read_cmos_sensor_8(ctx, 0x0202) & 0xff) << 8) |  (read_cmos_sensor_8(ctx, 0x0203) & 0xff);
    se_b = ((read_cmos_sensor_8(ctx, 0x0224) & 0xff) << 8) |  (read_cmos_sensor_8(ctx, 0x0225) & 0xff);
    LOG_INF("read from sensor le: 0x%x(%d), se: 0x%x(%d)", le_b, le_b, se_b, se_b);
#endif
}

static void hdr_write_double_gain(struct subdrv_ctx *ctx, kal_uint16 lgain, kal_uint16 sgain)
{
...
#if 0
    //read back
    lg_b = ((read_cmos_sensor_8(ctx, 0x0204) & 0xff) << 8) |  (read_cmos_sensor_8(ctx, 0x0205) & 0xff);
    sg_b = ((read_cmos_sensor_8(ctx, 0x0216) & 0xff) << 8) |  (read_cmos_sensor_8(ctx, 0x0217) & 0xff);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = 1906000;
        LOG_INF("exporsure");
    break;
