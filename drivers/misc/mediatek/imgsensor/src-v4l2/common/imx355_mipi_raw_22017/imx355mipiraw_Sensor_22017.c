...
#include "imx355_eeprom_22017.h"
#include "imx355_ana_gain_table_22017.h"
#include "imx355mipiraw_Sensor_22017.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_22017,
...
static kal_uint16 addr_data_pair_init_imx355[] = {
    0x0106, 0x01,
    0x0136, 0x18,
    0x0137, 0x00,
    0x4348, 0x16,
...
static kal_uint16 addr_data_pair_preview_imx355[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, addr_data_pair_preview_imx355,
    sizeof(addr_data_pair_preview_imx355) / sizeof(kal_uint16));
    /* zvhdr_setting(ctx); */
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}                /*    preview_setting  */

static kal_uint16 addr_data_pair_capture_imx355[] = {
     0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static kal_uint16 addr_data_pair_video_imx355[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor(ctx, addr_data_pair_video_imx355,
    sizeof(addr_data_pair_video_imx355) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 addr_data_pair_hs_video_imx355[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
    0x0342, 0x07,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, addr_data_pair_hs_video_imx355,
    sizeof(addr_data_pair_hs_video_imx355) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}
...
static kal_uint32 set_test_pattern_mode(struct subdrv_ctx *ctx, kal_bool enable)
{
    ...
    if (enable)
        write_cmos_sensor(ctx, 0x0601, 0x01);
    else
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, slim_video_setting_array,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, custom1_setting_array,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, custom2_setting_array,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, custom3_setting_array,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, custom4_setting_array,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor(ctx, custom5_setting_array,
                    ...
                    BYTE *data, int size)
{
	if (adaptor_i2c_rd_p8(ctx->i2c_client, imx355_EEPROM_READ_ID >> 1,
			addr, data, size) < 0) {
        LOG_INF("read imx355 eeprom data fail!");
		return false;
	}
	return true;
}
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX355_SENSOR_ID_22017) && (data_length == CALI_DATA_SLAVE_LENGTH)
...
{
    kal_uint16 idx = 0;
    read_imx355_eeprom_info_22017(ctx, EEPROM_META_MODULE_ID,
                &(imx355_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx355_common_data[1] << 8) |
                   imx355_common_data[0];
    read_imx355_eeprom_info_22017(ctx, EEPROM_META_SENSOR_ID,
                &(imx355_common_data[2]), 2);
    read_imx355_eeprom_info_22017(ctx, EEPROM_META_LENS_ID,
                &(imx355_common_data[4]), 2);
    read_imx355_eeprom_info_22017(ctx, EEPROM_META_VCM_ID,
                &(imx355_common_data[6]), 2);
    read_imx355_eeprom_info_22017(ctx, EEPROM_META_MODULE_SN,
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx355_ana_gain_table_22017);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx355_ana_gain_table_22017,
            sizeof(imx355_ana_gain_table_22017));
        }
        break;
    ...
    *feature_return_para_32++ = (imx355_common_data[1] << 24) |
        (imx355_common_data[0] << 16) |
        (imx355_common_data[3] << 8) |
        (imx355_common_data[2] & 0xFF);
    *feature_return_para_32 = (imx355_common_data[5] << 24) |
        (imx355_common_data[4] << 16) |
        (imx355_common_data[7] << 8) |
        (imx355_common_data[6] & 0xFF);
    *feature_para_len = 8;
    ...
    *feature_return_para_32++ = (imx355_common_data[11] << 24) |
        (imx355_common_data[10] << 16) |
        (imx355_common_data[9] << 8) |
        (imx355_common_data[8] & 0xFF);
    *feature_para_len = 4;
    ...
    *feature_para_len = OPLUS_CAMERA_COMMON_DATA_LENGTH;
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        pr_debug("imx355 get STEREO_DATA");
    ...
    case SENSOR_FEATURE_GET_PDAF_DATA:
        ...
        imx355_read_DCC_22017(ctx, (kal_uint16) (*feature_data),
...
const struct subdrv_entry imx355_mipi_raw_22017_entry = {
    .name = "imx355_mipi_raw_22017",
    .id = IMX355_SENSOR_ID_22017,
    .pw_seq = pw_seq,
