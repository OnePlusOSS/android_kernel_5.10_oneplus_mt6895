...
#include "imx766mipiraw_Sensor_22021.h"
#include "imx766_eeprom_22021.h"
#include "imx766_ana_gain_table_22021.h"
#include "imx766_Sensor_setting_22021.h"
...
#define IMX766_EEPROM_READ_ID_22021  0xA2
#define IMX766_EEPROM_WRITE_ID_22021 0xA2
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_READ_ID_22021 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX766_EEPROM_READ_ID_22021 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1,
...
static kal_int32 write_1st_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, 0x0);

    reg = 0x06ca;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, 0x2);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, 0x0);
    }

    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, &flag);
...
static kal_int32 write_2nd_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, 0x0E);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX766_EEPROM_WRITE_ID_22021 >> 1, reg, 0x00);
    }
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    u8 flag = 0;
    int ret = 0;
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX766_EEPROM_READ_ID_22021 >> 1, 0x000D, &flag);
    if ( flag == 0x01 ) {
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == IMX766_SENSOR_ID_22021) && (data_length == CALI_DATA_MASTER_LENGTH)
        ...
        } else if ((pStereodata->uSensorId == IMX766_SENSOR_ID_22021) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX766_AESYNC_START_ADDR_22021)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+1),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+2),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+3),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+4),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+5),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+6),
                    read_cmos_eeprom_8(ctx, IMX766_AESYNC_START_ADDR_22021+7));
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX766_SENSOR_ID_22021,
    ...
    .custom2 = { /* Reg_B_2_1_4096x3072_24FPS */
        .pclk = 3513600000,
        .linelength = 31232,
        .framelength = 4686,
        .startx = 0,
...
{
    kal_uint16 idx = 0;
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_MODULE_ID,
                &(imx766_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx766_common_data[1] << 8) |
                   imx766_common_data[0];
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_SENSOR_ID,
                &(imx766_common_data[2]), 2);
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_LENS_ID,
                &(imx766_common_data[4]), 2);
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_VCM_ID,
                &(imx766_common_data[6]), 2);
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_MODULE_SN,
                &(imx766_common_data[8]), 17);
    read_imx766_eeprom_info_22021(ctx, EEPROM_META_AF_CODE,
                &(imx766_common_data[25]), 7);
...
{
    LOG_INF("E\n");
    imx766_table_write_cmos_sensor_8(ctx, imx766_init_setting_22021,
        sizeof(imx766_init_setting_22021)/sizeof(kal_uint16));
...
static unsigned short imx766_seamless_preview_Optimize1[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
static unsigned short imx766_seamless_custom5_Optimize1[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_custom5_22021,
                sizeof(imx766_seamless_custom5_22021) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor_8(ctx, imx766_seamless_normal_preview_22021,
                 sizeof(imx766_seamless_normal_preview_22021) / sizeof(kal_uint16));
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx766_ana_gain_table_22021);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx766_ana_gain_table_22021,
            sizeof(imx766_ana_gain_table_22021));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_imx766_eeprom_info_22021(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
...
const struct subdrv_entry imx766_mipi_raw_22021_entry = {
    .name = "imx766_mipi_raw_22021",
    .id = IMX766_SENSOR_ID_22021,
    .pw_seq = pw_seq,
