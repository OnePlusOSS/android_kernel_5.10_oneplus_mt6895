...
#include "imx355_eeprom_21121.h"
#include "imx355_ana_gain_table_21121.h"
#include "imx355mipiraw_Sensor_21121.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_21121,
...
{
    kal_uint16 idx = 0;
    read_imx355_eeprom_info_21121(ctx, EEPROM_META_MODULE_ID,
                &(imx355_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx355_common_data[1] << 8) |
                   imx355_common_data[0];
    read_imx355_eeprom_info_21121(ctx, EEPROM_META_SENSOR_ID,
                &(imx355_common_data[2]), 2);
    read_imx355_eeprom_info_21121(ctx, EEPROM_META_LENS_ID,
                &(imx355_common_data[4]), 2);
    read_imx355_eeprom_info_21121(ctx, EEPROM_META_VCM_ID,
                &(imx355_common_data[6]), 2);
    read_imx355_eeprom_info_21121(ctx, EEPROM_META_MODULE_SN,
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx355_ana_gain_table_21121);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx355_ana_gain_table_21121,
            sizeof(imx355_ana_gain_table_21121));
        }
        break;
    ...
    *feature_para_len = OPLUS_CAMERA_COMMON_DATA_LENGTH;
    ...
    case SENSOR_FEATURE_GET_PDAF_DATA:
        ...
        imx355_read_DCC_21121(ctx, (kal_uint16) (*feature_data),
...
const struct subdrv_entry imx355_mipi_raw_21121_entry = {
    .name = "imx355_mipi_raw_21121",
    .id = IMX355_SENSOR_ID_21121,
    .pw_seq = pw_seq,
