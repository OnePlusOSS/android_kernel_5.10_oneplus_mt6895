...
#include "imx709mipiraw_Sensor_22021.h"
#include "imx709_ana_gain_table_22021.h"
#include "imx709_eeprom_22021.h"
#include "imx709_vcm_22021.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709_SENSOR_ID_22021,
    .checksum_value = 0x5a6563df,

    .pre = { /* reg_B3_2 3264*2448@29fps*/
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2504,
        .startx = 0,
        ...
        .max_framerate = 293, /* 29.34fps */
    },

    .cap = { /* reg_B3_2 3264*2448@29fps*/
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2504,
        .startx = 0,
    ...
    .normal_video = { /* reg_C5_2 3264*1856@30fps*/
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
    ...
    .custom6 = {/* reg_C5_2 3264*1856@30fps*/
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
    ...
    .custom7 = {  /*preisp , regI5_2 3264*1856@30FPS 2DOL*/
        .pclk = 864000000,
        .linelength = 7456,
        .framelength = 3856,
        .startx = 0,
    ...
    .custom10 = {  /*reg H2 1632x1224 @30FPS with pd*/
        .pclk = 355200000,
        .linelength = 5880,
        .framelength = 2008,
        .startx = 0,
...
{
    kal_uint16 idx = 0;
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_MODULE_ID,
                &(imx709_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx709_common_data[1] << 8) |
                   imx709_common_data[0];
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_SENSOR_ID,
                &(imx709_common_data[2]), 2);
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_LENS_ID,
                &(imx709_common_data[4]), 2);
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_VCM_ID,
                &(imx709_common_data[6]), 2);
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_MODULE_SN,
                &(imx709_common_data[8]), 17);
    read_imx709_eeprom_info_22021(ctx, EEPROM_META_AF_CODE,
                &(imx709_common_data[25]), 7);
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    ...
                    read_imx709_LRC_22021(ctx, imx709_LRC_setting);
                    read_imx709_QSC_22021(ctx, imx709_QSC_setting);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx709_ana_gain_table_22021);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx709_ana_gain_table_22021,
            sizeof(imx709_ana_gain_table_22021));
        }
        break;
...
const struct subdrv_entry imx709_mipi_raw_22021_entry = {
    .name = "imx709_mipi_raw_22021",
    .id = IMX709_SENSOR_ID_22021,
    .pw_seq = pw_seq,
