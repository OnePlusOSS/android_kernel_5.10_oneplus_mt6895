...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .custom4 = {
        ...
        .startx = 0,
        .starty = 0,
        .grabwindow_width  = 2896,
        .grabwindow_height = 2172,
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 998400000,
        .max_framerate = 300,
    },
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    ...
    { 11584, 8688,   32, 1104, 11520, 6480,  2880, 1620,    0,    0,  2880, 1620, 0,   0,   2880, 1620},// high_speed_video
    ...
    { 11584, 8688,    0,    0,  5792, 4344,  5792, 4344,    0,    0,  5792, 4344, 0,   0,   5792, 4344},// custom2
    { 11584, 8688,    0,    0, 11584, 8688, 11584, 8688,    0,    0, 11584, 8688, 0,   0,  11584, 8688},// custom3
    { 11584, 8688,    0,    0, 11584, 8688,  2896, 2172,    0,    0,  2896, 2172, 0,   0,   2896, 2172},// custom4
    { 11584, 8688,    0,    0, 11584, 8688,  4000, 3000,    0,    0,  4000, 3000, 0,   0,   4000, 3000},// custom5
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[10] = {
    ...
    {
        0x02, 0x0a, 0x0000, 0x0008, 0x40, 0x00,
        0x00, 0x2b, 0x0FA0, 0x08ca, 0x00, 0x00, 0x0000, 0x0000,
        0x01, 0x2B, 0x02d0, 0x032e, 0x03, 0x00, 0x0000, 0x0000
    },
    ...
    {
        0x02, 0x0a, 0x0000, 0x0008, 0x40, 0x00,
        0x00, 0x2b, 0x0b50, 0x087c, 0x00, 0x00, 0x0000, 0x0000,
        0x01, 0x2b, 0x02d0, 0x043c, 0x03, 0x00, 0x0000, 0x0000
    },
...
// sensorid : [30 ~ 33]
	...
	//vcm
	ova0b4_changzheng_common_data[40] = read_ova0b4_changzheng_eeprom_module(vcmAddr);
	ova0b4_changzheng_common_data[41] = read_ova0b4_changzheng_eeprom_module(vcmAddr + 1);
	//lensid
	ova0b4_changzheng_common_data[44] = read_ova0b4_changzheng_eeprom_module(lensAddr);
	ova0b4_changzheng_common_data[45] = read_ova0b4_changzheng_eeprom_module(lensAddr + 1);
	//macro
	ova0b4_changzheng_common_data[48] = read_ova0b4_changzheng_eeprom_module(macAddr_lsb);
	ova0b4_changzheng_common_data[49] = read_ova0b4_changzheng_eeprom_module(macAddr_msb);
	//inf
	ova0b4_changzheng_common_data[52] = read_ova0b4_changzheng_eeprom_module(infAddr_lsb);
	ova0b4_changzheng_common_data[53] = read_ova0b4_changzheng_eeprom_module(infAddr_msb);
	//sensor id
	ova0b4_changzheng_common_data[30] = ((sensor_id) >> 24) & 0xff;
	ova0b4_changzheng_common_data[31] = ((sensor_id) >> 16) & 0xff;
	ova0b4_changzheng_common_data[32] = ((sensor_id) >> 8) & 0xff;
	ova0b4_changzheng_common_data[33] = (sensor_id) & 0xff;
