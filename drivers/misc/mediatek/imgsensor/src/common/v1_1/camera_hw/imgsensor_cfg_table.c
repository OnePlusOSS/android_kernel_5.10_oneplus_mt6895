...
#include "gpio/gpio.h"
#include "wl2868c_hw/wl2868c_hw.h"
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_WL2868C},
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_WL2868C},
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_WL2868C},
			{IMGSENSOR_HW_PIN_AFVDD, IMGSENSOR_HW_ID_WL2868C},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_AVDD1, IMGSENSOR_HW_ID_NONE},
