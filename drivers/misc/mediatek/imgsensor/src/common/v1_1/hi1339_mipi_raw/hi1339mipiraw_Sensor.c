 ...
 *============================================================================
 ****************************************************************************/
#define PFX "HI1339_camera_sensor"
...
#if USE_BURST_MODE
static kal_uint16 hi1339_table_write_cmos_sensor(
...
static void write_shutter(kal_uint32 shutter)
{
	...
	/* Update Shutter */
     write_cmos_sensor(0x020C, (shutter & 0xFFFF0000) >> 16 );
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    write_cmos_sensor(0x0212,reg_gain);
...
#define I2C_BUFFER_LEN 255 /* trans# max is 255, each 3 bytes */
static kal_uint16 hi1339_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 hi1339_init_setting[] = {
	0x0790, 0x0100,
	0x2000, 0x0000,
	0x2002, 0x0058,
	0x2006, 0x40B2,
...
static kal_uint16 hi1339_preview_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003D,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339_capture_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339_normal_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339_slim_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339_hs_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static void sensor_init(void)
{
    ...
    hi1339_table_write_cmos_sensor(hi1339_init_setting,
		sizeof(hi1339_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	hi1339_table_write_cmos_sensor(hi1339_preview_setting,
		sizeof(hi1339_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	hi1339_table_write_cmos_sensor(hi1339_capture_setting,
		sizeof(hi1339_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	hi1339_table_write_cmos_sensor(hi1339_normal_video_setting,
		sizeof(hi1339_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	hi1339_table_write_cmos_sensor(hi1339_hs_video_setting,
		sizeof(hi1339_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	hi1339_table_write_cmos_sensor(hi1339_slim_video_setting,
		sizeof(hi1339_slim_video_setting)/sizeof(kal_uint16));
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			pr_debug("Read sensor id fail, id: 0x%x, read data : 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
	...
	pr_debug("%s HI-1339 initial setting start \n", __func__);
	sensor_init();
	pr_debug("%s HI-1339 initial setting end \n", __func__);
...
break;
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_eeprom_hi1339((kal_uint16)(*feature_data),
