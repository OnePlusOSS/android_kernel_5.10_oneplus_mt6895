...
#include "gc02m1_mipi_changzheng_Sensor.h"
...
#define EEPROM_I2C_ADDR 0xA4
static kal_uint8 deviceInfo_register_value = 0x00;
extern void register_imgsensor_deviceinfo(char *name, char *version, u8 module_id);
#define DEVICE_VERSION_CHANGZHENG_GC02M1    "gc02m1"

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID_CHANGZHENG,
...
kal_uint16 addr_data_pair_sw_init_gc02m1[] = {
...
kal_uint16 addr_data_pair_sw_preview_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_sw_capture_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_sw_normal_video_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_sw_hs_video_gc02m1[] = {
	0xfe, 0x00,
};

kal_uint16 addr_data_pair_sw_slim_video_gc02m1[] = {
	0xfe, 0x00,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1,
		sizeof(addr_data_pair_sw_init_gc02m1) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1,
		sizeof(addr_data_pair_sw_preview_gc02m1) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1,
		sizeof(addr_data_pair_sw_capture_gc02m1) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1,
		sizeof(addr_data_pair_sw_normal_video_gc02m1) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1,
		sizeof(addr_data_pair_sw_hs_video_gc02m1) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1,
		sizeof(addr_data_pair_sw_slim_video_gc02m1) /
		sizeof(kal_uint16));
}
...
static BYTE gc02m1_changzheng_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_gc02m1_changzheng_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
...
static void read_gc02m1_changzheng_module_data(UINT32 sensor_id)
{
// gc02m1_changzheng_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
...
// sensorid : [30 ~ 33]
	...
	memset(gc02m1_changzheng_common_data, 0,sizeof(gc02m1_changzheng_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		gc02m1_changzheng_common_data[8 + idx] = read_gc02m1_changzheng_eeprom_module(sn_starAddr + idx);
	}
	//lensid
	gc02m1_changzheng_common_data[44] = read_gc02m1_changzheng_eeprom_module(lensAddr);
	gc02m1_changzheng_common_data[45] = read_gc02m1_changzheng_eeprom_module(lensAddr + 1);
	//sensor id
	gc02m1_changzheng_common_data[30] = ((sensor_id) >> 24) & 0xff;
	gc02m1_changzheng_common_data[31] = ((sensor_id) >> 16) & 0xff;
	gc02m1_changzheng_common_data[32] = ((sensor_id) >> 8) & 0xff;
	gc02m1_changzheng_common_data[33] = (sensor_id) & 0xff;

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
	{
		pr_debug("cam data: %02x %02x %02x %02x\n",
		       gc02m1_changzheng_common_data[idx],
		       gc02m1_changzheng_common_data[idx + 1],
		       gc02m1_changzheng_common_data[idx + 2],
		       gc02m1_changzheng_common_data[idx + 3]);
	}
}
		...
		do {
			*sensor_id = (return_sensor_id());
			if (*sensor_id == imgsensor_info.sensor_id) {
				imgsensor_info.module_id = 0x09;
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r2", DEVICE_VERSION_CHANGZHENG_GC02M1, imgsensor_info.module_id);
					deviceInfo_register_value = 0x01;
				}
				printk("gc02m1 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				read_gc02m1_changzheng_module_data(*sensor_id);
				return ERROR_NONE;
			}
			printk("gc02m1 Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, gc02m1_changzheng_common_data,
