...
static kal_uint16 imx766_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
{
	kal_uint16 idx = 0, addr_qsc = 0x1e30, sensor_qsc = 0xc800;
...
#define IMX766_GAIN_TABL_SIZE 432
kal_uint16 imx766_gain_ratio[IMX766_GAIN_TABL_SIZE] = {
	64,
	65,
	66,
	67,
...
kal_uint16 imx766_gain_reg[IMX766_GAIN_TABL_SIZE] = {
	0,
	240,
	496,
	720,
...
#ifdef USE_GAIN_TABLE
	reg_gain = imx766_gain_reg[IMX766_GAIN_TABL_SIZE - 1];
	for (i = 0; i < IMX766_GAIN_TABL_SIZE; i++) {
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	{
		...
		FMC_GPH_START;
		imx766_table_write_cmos_sensor(changed_reg_setting,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx766_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		imx766_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
