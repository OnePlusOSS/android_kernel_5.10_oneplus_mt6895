...
// sensorid : [30 ~ 33]
	...
	//lensid
	ov32c_changzheng_common_data[44] = read_ov32c_changzheng_eeprom_module(lensAddr);
	ov32c_changzheng_common_data[45] = read_ov32c_changzheng_eeprom_module(lensAddr + 1);
	//sensor id
	ov32c_changzheng_common_data[30] = ((sensor_id) >> 24) & 0xff;
	ov32c_changzheng_common_data[31] = ((sensor_id) >> 16) & 0xff;
	ov32c_changzheng_common_data[32] = ((sensor_id) >> 8) & 0xff;
	ov32c_changzheng_common_data[33] = (sensor_id) & 0xff;
