...
int wait_fp_event(void *data, unsigned int size, struct fingerprint_message_t **msg) {
	int ret;
...
int send_fingerprint_msg(int module, int event, void *data, unsigned int size) {
	int ret = 0;
	int need_report = 0;
