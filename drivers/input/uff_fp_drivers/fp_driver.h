...
#define oplus_driver_register(pdriver) platform_driver_register(pdriver);
#define oplus_driver_unregister(pdriver) platform_driver_unregister(pdriver);

#elif defined(USE_SPI_BUS)
typedef struct spi_device oplus_fp_device;
typedef struct spi_driver oplus_driver;
#define oplus_driver_register(pdriver) spi_register_driver(pdriver);
#define oplus_driver_unregister(pdriver) spi_unregister_driver(pdriver);
#endif
...
#define oplus_register_notifier_client(pnotifier) msm_drm_register_client(pnotifier);
