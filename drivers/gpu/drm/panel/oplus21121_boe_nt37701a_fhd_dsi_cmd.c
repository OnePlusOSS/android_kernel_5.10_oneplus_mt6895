...
{
	jdi_dcs_write_seq_static(ctx, 0xF0,0x55,0xAA,0x52,0x08,0x00);//dither on
	jdi_dcs_write_seq_static(ctx, 0x6F,0x01);
	jdi_dcs_write_seq_static(ctx, 0xB1,0xB2,0x63);
	jdi_dcs_write_seq_static(ctx, 0x8B,0x00);//FRC off
	...
	jdi_dcs_write_seq_static(ctx,0xC3,0x95,0x01,0x8E,0xD0,0x22,0x02,0x00);
	jdi_dcs_write_seq_static(ctx,0x11);
	usleep_range(64000, 64100);
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	pr_err("[lh]debug for nt37701a lcm %s, ctx->prepared %d\n", __func__, ctx->prepared);
...
static void mode_switch_to_120(struct drm_panel *panel)
{
	...
	pr_info("%s\n", __func__);
        ...
        jdi_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x01);
        jdi_dcs_write_seq_static(ctx, 0xC3, 0x99, 0x01, 0x94, 0xD0, 0x22, 0x02, 0x00);
...
#endif
	register_device_proc("lcd", "boe_nt37701a_tb", "boe");
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "oplus21121_boe_nt37701a_fhd_dsi_cmd",
		.owner = THIS_MODULE,
