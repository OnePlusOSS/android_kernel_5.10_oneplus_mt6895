...
extern int oplus_get_panel_serial_number_interface(struct drm_crtc *crtc,int level);
...
/* #ifdef OPLUS_FEATURE_DISPLAY */
	ret = oplus_get_panel_serial_number_interface(crtc,level);
	if ((ret == 0) && (readcount == 0)) {
